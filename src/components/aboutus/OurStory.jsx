                ...
                <Row className='my-5 py-5 align-items-center'>
                    ...
                    <Col xs={12} sm={12} md={6} lg={6}>
                        <div className='our-story-description'>
                            ...
                            <p className='about-us-text'>We support this with our strong commitment to customer service, timeliness, legal compliance all delivered via innovative technology. Many providers will claim to be exactly what you are looking for but by choosing DOMESTIREG you can be confident we will get it right every time.</p>
