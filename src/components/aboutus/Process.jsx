                ...
                <Row className=''>
                    ...
                    <Col xs={12} lg={6}>
                        <Row>
                            ...
                            <Col xs={12} sm={6} md={6}>
                                <div className='shadow-lg text-center py-4 px-2 mt-5 about-us-process' >
                                    <Icons icon='user-check' size={60} className={'text-pink bg-light-pink p-3 mb-3 rounded-circle'} />
                            ...
                            <Col xs={12} sm={6} md={6}>
                                <div className='shadow-lg text-center py-4 px-2 mt-5 about-us-process'>
                                    <Icons icon='shield' size={60} className={'text-pink bg-light-pink p-3 mb-3 rounded-circle'} />
                            ...
                            <Col xs={12} sm={6} md={6}>
                               <div className='shadow-lg text-center py-4 px-2 mt-5 about-us-process'>
                                    <Icons icon='check-circle' size={60} className={'text-pink bg-light-pink p-3 mb-3 rounded-circle'} />
                                    <h6>Get Result</h6>
